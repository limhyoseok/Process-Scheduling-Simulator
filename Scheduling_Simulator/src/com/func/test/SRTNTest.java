...
class SRTNTest {
	...
	void testDoScheduling() {
		...
		obj[2]=new Process(6, 3, 9, 0, 3);
		obj[3]=new Process(5, 5, 13, 4, 9);
		obj[4]=new Process(1, 7, 20, 12, 19);
		for(int i=0;i<5;i++) {
	...
	void testdoScheduling2() {
		...
		obj[8]=new Process(6, 3, 9, 0, 3);
		obj[9]=new Process(1, 5, 10, 4, 9);
		obj[10]=new Process(9, 2, 11, 0, 2);
		obj[11]=new Process(2, 5, 12, 5, 10);
		obj[12]=new Process(10, 3, 13, 0, 3);
		obj[13]=new Process(4, 6, 15, 5, 11);
